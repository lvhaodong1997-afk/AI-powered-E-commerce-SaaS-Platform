...
public final class TkGeminiPromptConfig {
    ...
    public static final String DEFAULT_ANALYSIS_PROMPT = String.join("\n",
            ...
            "7. 时长控制规则：15秒英文 35-45 words、中文 65-90 字；20秒英文 45-60 words、中文 90-120 字；30秒英文 70-90 words、中文 140-180 字；45秒英文 105-130 words、中文 210-260 字；60秒英文 140-170 words、中文 280-340 字；90秒英文 210-255 words、中文 420-510 字；120秒英文 280-340 words、中文 560-680 字；180秒英文 420-510 words、中文 840-1020 字；500秒英文 1165-1415 words、中文 2330-2830 字。",
            "8. 如果用户目标时长介于上述区间，按比例控制；每条 scriptText 根据时长控制在 4-125 句，每句适合 2-4 秒字幕展示。",
    ...
    public static final String DEFAULT_GENERATION_SCRIPT_PROMPT = String.join("\n",
            ...
            "8. 时长控制规则：15秒英文 35-45 words、中文 65-90 字；20秒英文 45-60 words、中文 90-120 字；30秒英文 70-90 words、中文 140-180 字；45秒英文 105-130 words、中文 210-260 字；60秒英文 140-170 words、中文 280-340 字；90秒英文 210-255 words、中文 420-510 字；120秒英文 280-340 words、中文 560-680 字；180秒英文 420-510 words、中文 840-1020 字；500秒英文 1165-1415 words、中文 2330-2830 字。",
            "9. 如果目标成片时长介于上述区间，按比例控制；全文根据时长控制在 4-125 句，句子之间自然断开，方便字幕切分。",
