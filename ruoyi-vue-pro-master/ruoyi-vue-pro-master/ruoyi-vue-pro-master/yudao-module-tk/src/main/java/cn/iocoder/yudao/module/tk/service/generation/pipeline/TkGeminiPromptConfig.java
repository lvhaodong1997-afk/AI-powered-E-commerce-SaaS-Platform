...
public final class TkGeminiPromptConfig {
    ...
    public static final String DEFAULT_ANALYSIS_PROMPT = String.join("\n",
            ...
            "7. 时长控制规则：15秒英文 35-45 words、中文 65-90 字；20秒英文 45-60 words、中文 90-120 字；30秒英文 70-90 words、中文 140-180 字；45秒英文 105-130 words、中文 210-260 字；60秒英文 140-170 words、中文 280-340 字。",
            "8. 如果用户目标时长介于上述区间，按比例控制；每条 scriptText 控制在 4-10 句，每句适合 2-4 秒字幕展示。",
    ...
    public static final String DEFAULT_GENERATION_SCRIPT_PROMPT = String.join("\n",
            ...
            "8. 时长控制规则：15秒英文 35-45 words、中文 65-90 字；20秒英文 45-60 words、中文 90-120 字；30秒英文 70-90 words、中文 140-180 字；45秒英文 105-130 words、中文 210-260 字；60秒英文 140-170 words、中文 280-340 字。",
            "9. 如果目标成片时长介于上述区间，按比例控制；全文控制在 4-10 句，句子之间自然断开，方便字幕切分。",
