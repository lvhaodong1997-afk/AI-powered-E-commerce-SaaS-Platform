      ...
      SELECT table_name,
             CASE table_name
               ...
               WHEN 'tk_generation_route_history' THEN 'TK 生成路由历史'
                ...
                WHEN 'tk_open_tiktok_publish_attempt' THEN 'TK 开放 API TikTok 发布尝试记录'
                WHEN 'tk_social_account' THEN 'TK 社交平台账号'
                WHEN 'tk_social_account_stats' THEN 'TK 社交账号统计'
                WHEN 'tk_social_auth_session' THEN 'TK 社交平台授权会话'
                WHEN 'tk_social_media' THEN 'TK 社交媒体素材'
                WHEN 'tk_social_media_stats' THEN 'TK 社交媒体统计'
                WHEN 'tk_social_publish_detail' THEN 'TK 社交平台发布明细'
                WHEN 'tk_social_publish_task' THEN 'TK 社交平台发布任务'
          ...
          SELECT c.table_name,
                 ...
                 CASE
                   ...
                   WHEN c.table_name = 'tk_tiktok_publish_media' AND c.column_name = 'status'
                     THEN '视频状态'
                   WHEN c.table_name = 'tk_tiktok_publish_task' AND c.column_name = 'scheduled_at'
                     THEN '计划发布时间'
                   WHEN c.table_name = 'tk_tiktok_publish_task' AND c.column_name = 'schedule_status'
                     THEN '定时发布状态'
                   WHEN c.table_name = 'tk_tiktok_publish_task' AND c.column_name = 'schedule_version'
                     THEN '定时发布版本号'
                   WHEN c.table_name = 'tk_tiktok_publish_task' AND c.column_name = 'started_at'
                     THEN '实际开始时间'
                   WHEN c.table_name = 'tk_tiktok_publish_task' AND c.column_name = 'finished_at'
                     THEN '实际完成时间'
                   WHEN c.table_name = 'tk_tiktok_publish_task' AND c.column_name = 'scheduled_local_path'
                     THEN '定时发布持久化素材路径'
                   WHEN c.table_name = 'tk_tiktok_publish_task' AND c.column_name = 'scheduled_media_status'
                     THEN '定时发布素材状态'
                   WHEN c.table_name = 'tk_tiktok_publish_task' AND c.column_name = 'scheduled_media_fail_reason'
                     THEN '定时发布素材失败原因'
                   ...
                   WHEN c.table_name = 'tk_voice_profile' AND c.column_name = 'mimo_sample_url'
                    ...
                    WHEN c.table_name = 'tk_voice_profile' AND c.column_name = 'sample_file_url'
                      THEN '授权参考音频'
                    WHEN c.table_name = 'tk_open_tiktok_publish_attempt' AND c.column_name = 'client_id'
                      THEN '开放 API 客户端编号'
                    WHEN c.table_name = 'tk_open_tiktok_publish_attempt' AND c.column_name = 'task_id'
                      THEN '发布任务编号'
                    WHEN c.table_name = 'tk_open_tiktok_publish_attempt' AND c.column_name = 'detail_id'
                      THEN '发布明细编号'
                    WHEN c.table_name = 'tk_open_tiktok_publish_attempt' AND c.column_name = 'attempt_no'
                      THEN '尝试次数'
                    WHEN c.table_name = 'tk_open_tiktok_publish_attempt' AND c.column_name = 'owner_token'
                      THEN '执行者令牌'
                    WHEN c.table_name = 'tk_open_tiktok_publish_attempt' AND c.column_name = 'phase'
                      THEN '发布阶段'
                    WHEN c.table_name = 'tk_open_tiktok_publish_attempt' AND c.column_name = 'started_time'
                      THEN '开始时间'
                    WHEN c.table_name = 'tk_open_tiktok_publish_attempt' AND c.column_name = 'heartbeat_time'
                      THEN '心跳时间'
                    WHEN c.table_name = 'tk_open_tiktok_publish_attempt' AND c.column_name = 'publish_id'
                      THEN 'TikTok 发布编号'
                    WHEN c.table_name = 'tk_open_tiktok_publish_attempt' AND c.column_name = 'upload_source'
                      THEN '上传来源'
                    WHEN c.table_name = 'tk_open_tiktok_publish_attempt' AND c.column_name = 'upload_url_cipher'
                      THEN '上传地址密文'
                    WHEN c.table_name = 'tk_open_tiktok_publish_attempt' AND c.column_name = 'file_sha256'
                      THEN '文件 SHA-256'
                    WHEN c.table_name = 'tk_open_tiktok_publish_attempt' AND c.column_name = 'file_size'
                      THEN '文件大小（字节）'
                    WHEN c.table_name = 'tk_open_tiktok_publish_attempt' AND c.column_name = 'last_error'
                      THEN '最近错误信息'
                    WHEN c.table_name = 'tk_open_tiktok_publish_attempt' AND c.column_name = 'terminal_source'
                      THEN '终态来源'
                    WHEN c.table_name = 'tk_open_tiktok_publish_attempt' AND c.column_name = 'terminal_time'
                      THEN '终态时间'
                    WHEN c.table_name = 'tk_open_tiktok_publish_attempt' AND c.column_name = 'next_reconcile_time'
                      THEN '下次对账时间'
                    WHEN c.table_name = 'tk_open_tiktok_publish_attempt' AND c.column_name = 'reconcile_count'
                      THEN '对账次数'
                    WHEN c.table_name = 'tk_social_account' AND c.column_name = 'platform'
                      THEN '社交平台'
                    WHEN c.table_name = 'tk_social_account' AND c.column_name = 'account_type'
                      THEN '账号类型'
                    WHEN c.table_name = 'tk_social_account' AND c.column_name = 'external_account_id'
                      THEN '外部账号编号'
                    WHEN c.table_name = 'tk_social_account' AND c.column_name = 'provider_user_id'
                      THEN '平台用户编号'
                    WHEN c.table_name = 'tk_social_account' AND c.column_name = 'account_name'
                      THEN '账号名称'
                    WHEN c.table_name = 'tk_social_account' AND c.column_name = 'username'
                      THEN '账号用户名'
                    WHEN c.table_name = 'tk_social_account' AND c.column_name = 'access_token_ciphertext'
                      THEN '访问令牌密文'
                    WHEN c.table_name = 'tk_social_account' AND c.column_name = 'token_type'
                      THEN '令牌类型'
                    WHEN c.table_name = 'tk_social_account' AND c.column_name = 'scopes'
                      THEN '授权范围'
                    WHEN c.table_name = 'tk_social_account' AND c.column_name = 'token_expires_at'
                      THEN '令牌过期时间'
                    WHEN c.table_name = 'tk_social_account' AND c.column_name = 'last_validated_at'
                      THEN '最近校验时间'
                    WHEN c.table_name IN ('tk_social_account_stats', 'tk_social_media_stats') AND c.column_name = 'object_id'
                      THEN '统计对象编号'
                    WHEN c.table_name IN ('tk_social_account_stats', 'tk_social_media_stats') AND c.column_name = 'social_account_id'
                      THEN '社交账号编号'
                    WHEN c.table_name IN ('tk_social_account_stats', 'tk_social_media_stats') AND c.column_name = 'platform'
                      THEN '社交平台'
                    WHEN c.table_name IN ('tk_social_account_stats', 'tk_social_media_stats') AND c.column_name = 'published_time'
                      THEN '发布时间'
                    WHEN c.table_name IN ('tk_social_account_stats', 'tk_social_media_stats') AND c.column_name = 'followers'
                      THEN '粉丝数'
                    WHEN c.table_name IN ('tk_social_account_stats', 'tk_social_media_stats') AND c.column_name = 'following'
                      THEN '关注数'
                    WHEN c.table_name IN ('tk_social_account_stats', 'tk_social_media_stats') AND c.column_name = 'media_count'
                      THEN '媒体数量'
                    WHEN c.table_name IN ('tk_social_account_stats', 'tk_social_media_stats') AND c.column_name = 'views'
                      THEN '播放量'
                    WHEN c.table_name IN ('tk_social_account_stats', 'tk_social_media_stats') AND c.column_name = 'likes'
                      THEN '点赞数'
                    WHEN c.table_name IN ('tk_social_account_stats', 'tk_social_media_stats') AND c.column_name = 'comments'
                      THEN '评论数'
                    WHEN c.table_name IN ('tk_social_account_stats', 'tk_social_media_stats') AND c.column_name = 'shares'
                      THEN '分享数'
                    WHEN c.table_name IN ('tk_social_account_stats', 'tk_social_media_stats') AND c.column_name = 'saves'
                      THEN '收藏数'
                    WHEN c.table_name IN ('tk_social_account_stats', 'tk_social_media_stats') AND c.column_name = 'reach'
                      THEN '触达人数'
                    WHEN c.table_name IN ('tk_social_account_stats', 'tk_social_media_stats') AND c.column_name = 'metrics_json'
                      THEN '统计指标 JSON'
                    WHEN c.table_name IN ('tk_social_account_stats', 'tk_social_media_stats') AND c.column_name = 'sync_status'
                      THEN '同步状态'
                    WHEN c.table_name IN ('tk_social_account_stats', 'tk_social_media_stats') AND c.column_name = 'last_attempt_time'
                      THEN '最近尝试时间'
                    WHEN c.table_name IN ('tk_social_account_stats', 'tk_social_media_stats') AND c.column_name = 'last_success_time'
                      THEN '最近成功时间'
                    WHEN c.table_name IN ('tk_social_account_stats', 'tk_social_media_stats') AND c.column_name = 'next_sync_time'
                      THEN '下次同步时间'
                    WHEN c.table_name IN ('tk_social_account_stats', 'tk_social_media_stats') AND c.column_name = 'last_manual_time'
                      THEN '最近手动同步时间'
                    WHEN c.table_name IN ('tk_social_account_stats', 'tk_social_media_stats') AND c.column_name = 'lease_token'
                      THEN '租约令牌'
                    WHEN c.table_name IN ('tk_social_account_stats', 'tk_social_media_stats') AND c.column_name = 'lease_until'
                      THEN '租约截止时间'
                    WHEN c.table_name = 'tk_social_auth_session' AND c.column_name = 'session_id'
                      THEN '授权会话编号'
                    WHEN c.table_name = 'tk_social_auth_session' AND c.column_name = 'platform'
                      THEN '社交平台'
                    WHEN c.table_name = 'tk_social_auth_session' AND c.column_name = 'state_hash'
                      THEN '状态哈希'
                    WHEN c.table_name = 'tk_social_auth_session' AND c.column_name = 'payload_ciphertext'
                      THEN '会话载荷密文'
                    WHEN c.table_name = 'tk_social_media' AND c.column_name = 'media_type'
                      THEN '媒体类型'
                    WHEN c.table_name = 'tk_social_media' AND c.column_name = 'file_name'
                      THEN '文件名'
                    WHEN c.table_name = 'tk_social_media' AND c.column_name = 'content_type'
                      THEN '内容类型'
                    WHEN c.table_name = 'tk_social_media' AND c.column_name = 'file_size'
                      THEN '文件大小（字节）'
                    WHEN c.table_name = 'tk_social_media' AND c.column_name = 'object_key'
                      THEN '对象存储键'
                    WHEN c.table_name = 'tk_social_media' AND c.column_name = 'public_url'
                      THEN '公开访问地址'
                    WHEN c.table_name = 'tk_social_media' AND c.column_name = 'width'
                      THEN '视频宽度（像素）'
                    WHEN c.table_name = 'tk_social_media' AND c.column_name = 'height'
                      THEN '视频高度（像素）'
                    WHEN c.table_name = 'tk_social_media' AND c.column_name = 'duration_seconds'
                      THEN '媒体时长（秒）'
                    WHEN c.table_name = 'tk_social_media' AND c.column_name = 'frame_rate'
                      THEN '视频帧率'
                    WHEN c.table_name = 'tk_social_media' AND c.column_name = 'metadata_status'
                      THEN '元数据状态'
                    WHEN c.table_name = 'tk_social_media' AND c.column_name = 'metadata_source'
                      THEN '元数据来源'
                    WHEN c.table_name = 'tk_social_media' AND c.column_name = 'metadata_error'
                      THEN '元数据错误信息'
                    WHEN c.table_name = 'tk_social_media' AND c.column_name = 'video_codec'
                      THEN '视频编码格式'
                    WHEN c.table_name = 'tk_social_media' AND c.column_name = 'audio_codec'
                      THEN '音频编码格式'
                    WHEN c.table_name = 'tk_social_media' AND c.column_name = 'video_bitrate'
                      THEN '视频码率（比特/秒）'
                    WHEN c.table_name = 'tk_social_media' AND c.column_name = 'audio_bitrate'
                      THEN '音频码率（比特/秒）'
                    WHEN c.table_name = 'tk_social_media' AND c.column_name = 'audio_sample_rate'
                      THEN '音频采样率（赫兹）'
                    WHEN c.table_name = 'tk_social_media' AND c.column_name = 'source_file_size'
                      THEN '源文件大小（字节）'
                    WHEN c.table_name = 'tk_social_media' AND c.column_name = 'source_etag'
                      THEN '源文件 ETag'
                    WHEN c.table_name = 'tk_social_media' AND c.column_name = 'source_version_id'
                      THEN '源文件版本编号'
                    WHEN c.table_name = 'tk_social_media' AND c.column_name = 'publish_object_key'
                      THEN '发布对象存储键'
                    WHEN c.table_name = 'tk_social_media' AND c.column_name = 'publish_etag'
                      THEN '发布文件 ETag'
                    WHEN c.table_name = 'tk_social_media' AND c.column_name = 'publish_version_id'
                      THEN '发布文件版本编号'
                    WHEN c.table_name = 'tk_social_media' AND c.column_name = 'normalized'
                      THEN '是否已标准化'
                    WHEN c.table_name = 'tk_social_media' AND c.column_name = 'inspection_attempts'
                      THEN '媒体检查次数'
                    WHEN c.table_name = 'tk_social_media' AND c.column_name = 'inspection_lease_token'
                      THEN '媒体检查租约令牌'
                    WHEN c.table_name = 'tk_social_media' AND c.column_name = 'inspection_lease_until'
                      THEN '媒体检查租约截止时间'
                    WHEN c.table_name = 'tk_social_media' AND c.column_name = 'inspection_next_retry'
                      THEN '下次检查重试时间'
                    WHEN c.table_name = 'tk_social_media' AND c.column_name = 'inspected_at'
                      THEN '最近检查时间'
                    WHEN c.table_name = 'tk_social_publish_task' AND c.column_name = 'media_id'
                      THEN '媒体编号'
                    WHEN c.table_name = 'tk_social_publish_task' AND c.column_name = 'title'
                      THEN '发布标题'
                    WHEN c.table_name = 'tk_social_publish_task' AND c.column_name = 'instagram_caption'
                      THEN 'Instagram 发布文案'
                    WHEN c.table_name = 'tk_social_publish_task' AND c.column_name = 'facebook_message'
                      THEN 'Facebook 发布内容'
                    WHEN c.table_name = 'tk_social_publish_task' AND c.column_name = 'idempotency_key'
                      THEN '幂等键'
                    WHEN c.table_name = 'tk_social_publish_task' AND c.column_name = 'request_hash'
                      THEN '请求哈希'
                    WHEN c.table_name = 'tk_social_publish_task' AND c.column_name = 'target_count'
                      THEN '目标数量'
                    WHEN c.table_name = 'tk_social_publish_task' AND c.column_name = 'success_count'
                      THEN '成功数量'
                    WHEN c.table_name = 'tk_social_publish_task' AND c.column_name = 'failed_count'
                      THEN '失败数量'
                    WHEN c.table_name = 'tk_social_publish_task' AND c.column_name = 'pending_count'
                      THEN '待处理数量'
                    WHEN c.table_name = 'tk_social_publish_detail' AND c.column_name = 'publish_task_id'
                      THEN '发布任务编号'
                    WHEN c.table_name = 'tk_social_publish_detail' AND c.column_name = 'social_account_id'
                      THEN '社交账号编号'
                    WHEN c.table_name = 'tk_social_publish_detail' AND c.column_name = 'platform'
                      THEN '社交平台'
                    WHEN c.table_name = 'tk_social_publish_detail' AND c.column_name = 'account_name'
                      THEN '账号名称'
                    WHEN c.table_name = 'tk_social_publish_detail' AND c.column_name = 'platform_status'
                      THEN '平台状态'
                    WHEN c.table_name = 'tk_social_publish_detail' AND c.column_name = 'external_container_id'
                      THEN '外部容器编号'
                    WHEN c.table_name = 'tk_social_publish_detail' AND c.column_name = 'external_media_id'
                      THEN '外部媒体编号'
                    WHEN c.table_name = 'tk_social_publish_detail' AND c.column_name = 'external_post_id'
                      THEN '外部帖子编号'
                    WHEN c.table_name = 'tk_social_publish_detail' AND c.column_name = 'publish_url'
                      THEN '发布链接'
                    WHEN c.table_name = 'tk_social_publish_detail' AND c.column_name = 'lease_token'
                      THEN '租约令牌'
                    WHEN c.table_name = 'tk_social_publish_detail' AND c.column_name = 'error_code'
                      THEN '错误码'
                    WHEN c.table_name = 'tk_social_publish_detail' AND c.column_name = 'error_message'
                      THEN '错误信息'
                    WHEN c.table_name = 'tk_social_publish_detail' AND c.column_name = 'poll_count'
                      THEN '轮询次数'
                    WHEN c.table_name = 'tk_social_publish_detail' AND c.column_name = 'next_retry_time'
                      THEN '下次重试时间'
                    WHEN c.table_name = 'tk_social_publish_detail' AND c.column_name = 'lease_until'
                      THEN '租约截止时间'
                    WHEN c.table_name = 'tk_social_publish_detail' AND c.column_name = 'published_time'
                      THEN '发布时间'
