...
CREATE TABLE IF NOT EXISTS `tk_open_tiktok_connection` (
  ...
  `bio_description` varchar(1024) DEFAULT NULL COMMENT 'TikTok account bio description',
  `profile_deep_link` varchar(1024) DEFAULT NULL COMMENT 'TikTok account profile deep link',
  `verified` bit(1) DEFAULT NULL COMMENT 'Whether the TikTok account is verified',
  `follower_count` bigint DEFAULT NULL COMMENT 'TikTok follower count',
  `following_count` bigint DEFAULT NULL COMMENT 'TikTok following count',
  `likes_count` bigint DEFAULT NULL COMMENT 'TikTok accumulated likes count',
  `video_count` bigint DEFAULT NULL COMMENT 'TikTok public video count',
  `stats_updated_at` datetime DEFAULT NULL COMMENT 'Time when TikTok profile statistics were refreshed',
