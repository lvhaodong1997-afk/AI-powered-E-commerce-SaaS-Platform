...
public interface ErrorCodeConstants {
    ...
    ErrorCode USER_TK_PLATFORM_ADMIN_FORBIDDEN = new ErrorCode(1_002_003_012, "只有平台管理员可以创建或授予平台管理员身份");
    ErrorCode USER_TK_TENANT_ADMIN_FORBIDDEN = new ErrorCode(1_002_003_013, "只有超级管理员可以创建或授予租户管理员身份");
    ErrorCode USER_ROLE_TENANT_MISMATCH = new ErrorCode(1_002_003_014, "用户与角色所属租户不一致");
    ErrorCode USER_TK_TENANT_REQUIRED = new ErrorCode(1_002_003_015, "请选择用户所属租户");
