...
public class TenantServiceImpl implements TenantService {
    ...
    private Long createUser(Long roleId, TenantSaveReqVO createReqVO) {
        // 创建用户
        UserSaveReqVO userReqVO = TenantConvert.INSTANCE.convert02(createReqVO);
        userReqVO.setTenantId(TenantContextHolder.getTenantId());
        Long userId = userService.createTenantAdminUser(userReqVO);
        // 分配角色
