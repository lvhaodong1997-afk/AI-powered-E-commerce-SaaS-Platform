...
public class UserController {
    ...
    public CommonResult<PageResult<UserRespVO>> getUserPage(@Valid UserPageReqVO pageReqVO) {
        ...
        return success(new PageResult<>(UserConvert.INSTANCE.convertList(pageResult.getList(), Collections.emptyMap()),
                pageResult.getTotal()));
    }
    ...
    public CommonResult<List<UserRespVO>> getUserList(@RequestParam("ids") List<Long> ids) {
        ...
        return success(UserConvert.INSTANCE.convertList(list, Collections.emptyMap()));
    }
    ...
    public CommonResult<List<UserSimpleRespVO>> getSimpleUserList() {
        ...
        return success(UserConvert.INSTANCE.convertSimpleList(list, Collections.emptyMap()));
    }
    ...
    public CommonResult<UserRespVO> getUser(@RequestParam("id") Long id) {
        ...
        return success(UserConvert.INSTANCE.convert(user, null));
    }
    ...
    public void exportUserList(@Validated UserPageReqVO exportReqVO,
        ...
        ExcelUtils.write(response, "用户数据.xls", "数据", UserRespVO.class,
                UserConvert.INSTANCE.convertList(list, Collections.emptyMap()));
    }
    ...
    public void importTemplate(HttpServletResponse response) throws IOException {
        ...
        List<UserImportExcelVO> list = Arrays.asList(
                UserImportExcelVO.builder().username("yunai").email("yunai@iocoder.cn").mobile("15601691300")
                        .nickname("秀美").status(CommonStatusEnum.ENABLE.getStatus()).sex(SexEnum.MALE.getSex()).build(),
    ...
    @Parameter(name = "nickname", description = "昵称关键词", required = true, example = "秀美")
