...
public class PermissionController {
    ...
    public CommonResult<Set<Long>> getRoleMenuList(Long roleId) {
        ...
        menuIds = TkPlatformAdminUtils.filterPlatformMenuIdsForTenantUser(menuService.getMenuList(menuIds), menuIds);
    ...
    public CommonResult<Boolean> assignRoleMenu(@Validated @RequestBody PermissionAssignRoleMenuReqVO reqVO) {
        ...
        reqVO.setMenuIds(TkPlatformAdminUtils.filterPlatformMenuIdsForTenantUser(
                menuService.getMenuList(reqVO.getMenuIds()), reqVO.getMenuIds()));
