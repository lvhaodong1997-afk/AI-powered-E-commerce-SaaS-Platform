...
public class AuthPermissionInfoRespVO {
    ...
    public static class UserVO {
        ...
        @Schema(description = "用户昵称", requiredMode = Schema.RequiredMode.REQUIRED, example = "秀美源码")
        ...
        @Schema(description = "TK 用户级别：PLATFORM_ADMIN/COMPANY_ADMIN/COMPANY_USER", example = "COMPANY_USER")
        private String tkUserLevel;

        @Schema(description = "TK 所属公司编号", example = "1")
    ...
    public static class MenuVO {
        ...
        @Schema(description = "菜单名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "秀美")
        private Long id;
