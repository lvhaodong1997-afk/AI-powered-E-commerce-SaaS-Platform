...
public class OAuth2TokenServiceImpl implements OAuth2TokenService {
    ...
    private static final String INFO_KEY_TK_COMPANY_ID = "tkCompanyId";
    ...
    public OAuth2AccessTokenDO createAccessToken(Long userId, Integer userType, String clientId, List<String> scopes) {
        Long tokenTenantId = resolveTokenTenantId(userId, userType);
        if (tokenTenantId != null) {
            return TenantUtils.execute(tokenTenantId, () -> doCreateAccessToken(userId, userType, clientId, scopes));
        }
        return doCreateAccessToken(userId, userType, clientId, scopes);
    }

    private OAuth2AccessTokenDO doCreateAccessToken(Long userId, Integer userType, String clientId, List<String> scopes) {
    ...
    private Long resolveTokenTenantId(Long userId, Integer userType) {
        if (userId == null || userId <= 0 || !UserTypeEnum.ADMIN.getValue().equals(userType)) {
            return TenantContextHolder.getTenantId();
        }
        AdminUserDO user = TenantUtils.executeIgnore(() -> adminUserService.getUser(userId));
        return user != null ? user.getTenantId() : TenantContextHolder.getTenantId();
    }
    ...
    private Map<String, String> buildUserInfo(Long userId, Integer userType) {
        ...
        if (userType.equals(UserTypeEnum.ADMIN.getValue())) {
            ...
            return MapUtil.builder(LoginUser.INFO_KEY_NICKNAME, user.getNickname())
                    ...
                    .put(INFO_KEY_TK_USER_LEVEL, user.getTkUserLevel())
                    .put(INFO_KEY_TK_COMPANY_ID, StrUtil.toStringOrNull(user.getTkCompanyId()))
                    .build();
