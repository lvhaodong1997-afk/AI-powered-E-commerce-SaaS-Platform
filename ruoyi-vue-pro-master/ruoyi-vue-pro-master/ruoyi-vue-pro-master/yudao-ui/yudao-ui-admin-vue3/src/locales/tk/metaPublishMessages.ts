...
const entries: Record<string, [string, string]> = {
  ...
  'meta.description': ['上传视频或选择系统成片，为每个平台设置独立文案。', 'Upload a video or choose a generated video, then set separate copy for each platform.'],
  'meta.refreshConfig': ['刷新配置', 'Refresh configuration'],
  'meta.configPending': ['Meta 发布配置待完成', 'Meta publishing setup is incomplete'],
  'meta.configPendingDescription': ['管理员启用并完成平台配置后，可在此连接账号和发布视频。', 'Connect accounts and publish videos after an administrator completes the platform configuration.'],
  'meta.availablePlatforms': ['可用平台', 'Available platforms'],
  'meta.supportedMedia': ['支持媒体', 'Supported media'],
  'meta.none': ['暂无', 'None'],
  'meta.videoUnsupported': ['当前服务端尚不支持视频，请完成视频发布配置后重试。', 'Video publishing is not supported by the current server. Complete the video publishing configuration and try again.'],
  ...
  'meta.accountQueryPermission': ['需要账号查询权限才能选择发布目标。', 'Account query permission is required to choose publishing targets.'],
  ...
  'meta.publishTargets': ['发布目标（可多选，每个账号独立执行）', 'Publishing targets (multiple selection; each account runs independently)'],
  'meta.publishTargetsPlaceholder': ['选择 Instagram / Facebook Page 账号（最多 20 个）', 'Select Instagram / Facebook Page accounts (up to 20)'],
  'meta.media': ['视频 / 图片', 'Video / image'],
  'meta.search': ['搜索', 'Search'],
  'meta.select': ['选择', 'Select'],
  'meta.generationQueryPermission': ['需要成片查询权限', 'Generated video query permission is required'],
  'meta.generatedTitle': ['成片标题', 'Generated video title'],
  'meta.generatedHint': ['仅显示生成成功的视频。服务端会校验成片归属和平台视频要求。', 'Only successfully generated videos are shown. The server validates ownership and platform video requirements.'],
  'meta.generatedFacebookHint': ['9:16、至少 540×960、23–60 fps、4–60 秒。此列表不含完整媒体参数，适用性待服务端校验。', '9:16, at least 540×960, 23–60 fps, and 4–60 seconds. This list does not include full media metadata; the server validates compatibility.'],
  ...
  'meta.mediaHint': ['MP4 最大 {{max}} MB，JPEG 最大 8 MB。视频将直接上传到 OSS，Instagram 必须选择媒体；Facebook 可只填写正文。服务端将进一步校验视频格式和平台限制。', 'MP4 up to {{max}} MB and JPEG up to 8 MB. Videos upload directly to OSS. Instagram requires media; Facebook can publish text only. The server will validate media format and platform limits.'],
  'meta.facebookVideoTitle': ['Facebook 视频将发布为 Reels', 'Facebook videos will be published as Reels'],
  'meta.facebookVideoDescription': ['本发布流程支持 9:16 竖屏、分辨率至少 540×960、帧率 23–60 fps、时长 4–60 秒。系统成片与上传视频都需通过服务端校验。', 'This flow supports 9:16 portrait videos, at least 540×960 resolution, 23–60 fps, and 4–60 seconds. Generated and uploaded videos must pass server-side validation.'],
  'meta.instagramVideoHint': ['Instagram 视频：本发布流程支持 23–60 fps，其他格式要求由服务端进一步校验。', 'Instagram video: this flow supports 23–60 fps; the server validates other format requirements.'],
  ...
  'meta.normalizedHint': ['已由服务端标准化处理，发布使用检测后的媒体。', 'The server normalized this media. The validated media will be published.'],
  ...
  'meta.taskCreated': ['已创建任务 #{{id}}。排队或平台处理中时无需重复提交，下方会自动刷新。', 'Task #{{id}} was created. Do not resubmit while it is queued or processing; the list below refreshes automatically.'],
  ...
  'meta.unknownWarning': ['结果未知时，请先到 Instagram / Facebook 人工核验是否已发布。此状态不允许重试，避免重复发布。', 'When the result is unknown, verify publication on Instagram / Facebook before retrying. Retrying is disabled to prevent duplicate posts.'],
  ...
  'meta.noBindablePage': ['当前授权没有可绑定主页，请检查账号的主页管理权限。', 'No bindable Page was found for this authorization. Check the account Page management permissions.'],
  ...
  'meta.statsNote': ['同步请求由后台执行。冷却期间不可重复请求；“—”表示暂无可用值，0 表示平台返回的真实零值。', 'Sync requests run in the background. Do not repeat requests during the cooldown; “—” means no value is available, while 0 is a real zero returned by the platform.'],
  ...
  'meta.noStats': ['暂无统计，请同步或稍后刷新；不会将缺失数据记为 0。', 'No statistics yet. Sync or refresh later; missing data is never recorded as 0.'],
  ...
  'meta.retryAfterAuthConfirm': ['请先完成此账号的重新授权，再提交重试。确认已授权？', 'Complete reauthorization for this account before retrying. Confirm that authorization is complete?'],
  'meta.retryAfterAuthTitle': ['授权后重试', 'Retry after authorization'],
  'meta.noStatsData': ['尚无统计数据', 'No statistics yet'],
  'meta.permissionDenied': ['没有执行此操作的权限', 'You do not have permission to perform this action'],
  'meta.setupIncompleteRetry': ['Meta 发布配置待完成，请刷新后重试', 'Meta publishing setup is incomplete. Refresh and try again'],
  'meta.taskRefreshFailed': ['状态刷新失败，正在重连；请勿重复创建任务。', 'Status refresh failed. Reconnecting; do not create duplicate tasks.'],
  'meta.accountTaskReadFailed': ['账号或任务读取失败，正在重连；请勿重复创建任务。', 'Account or task read failed. Reconnecting; do not create duplicate tasks.'],
  'meta.statsPollingPaused': ['同步等待较久，已暂停自动刷新，请手动刷新。', 'Sync is taking longer than expected. Automatic refresh is paused; refresh manually.'],
  'meta.statsReadFailed': ['统计读取失败', 'Failed to read statistics'],
  'meta.syncAccepted': ['同步请求已受理，等待后台完成。', 'Sync request accepted; waiting for the background job.'],
  'meta.syncNotCreated': ['请求未新建，等待服务器状态；请勿重复操作。', 'No new request was created. Waiting for server status; do not repeat the action.'],
  'meta.syncRequestFailed': ['同步请求失败', 'Sync request failed'],
  'meta.authTimeout': ['授权等待已超时，请重新连接账号。', 'Authorization timed out. Connect the account again.'],
  'meta.authWindowClosed': ['授权窗口已关闭，仍在等待服务器确认；可取消等待后重新连接。', 'The authorization window closed, but the server is still processing. Stop waiting and reconnect if needed.'],
  'meta.authReadRetry': ['授权状态暂时无法读取，正在重试。', 'Authorization status is temporarily unavailable. Retrying.'],
  'meta.platformUnavailable': ['服务器暂不支持此平台', 'This platform is not currently supported by the server'],
  'meta.popupBlocked': ['浏览器拦截了授权弹窗，请允许弹窗后重试', 'The browser blocked the authorization popup. Allow popups and try again'],
  'meta.invalidAuthUrl': ['授权地址无效，请检查配置', 'The authorization URL is invalid. Check the configuration'],
  'meta.authStartFailed': ['授权启动失败，请重试。', 'Authorization could not be started. Try again.'],
  'meta.pageBound': ['Facebook 主页绑定成功', 'Facebook Page bound successfully'],
  'meta.invalidPage': ['请从当前授权会话中选择有效主页', 'Select a valid Page from the current authorization session'],
  'meta.videoUnsupportedByServer': ['服务器暂不支持视频发布', 'Video publishing is not currently supported by the server'],
  'meta.invalidGeneratedVideo': ['请选择有效的成片', 'Select a valid generated video'],
  'meta.mediaDetectionPaused': ['检测等待较久，已暂停自动刷新，请手动刷新检测结果。', 'Detection is taking longer than expected. Automatic refresh is paused; refresh manually.'],
  'meta.mediaReadFailed': ['读取检测结果失败，请手动刷新', 'Failed to read detection results. Refresh manually'],
  'meta.mediaTypeUnsupported': ['仅支持 MP4 视频和 JPEG 图片', 'Only MP4 videos and JPEG images are supported'],
  'meta.mediaUnsupportedByServer': ['服务器暂不支持此媒体类型', 'This media type is not currently supported by the server'],
  'meta.waitMediaUpload': ['请等待媒体上传完成', 'Wait for the media upload to finish'],
  'meta.waitVideoDetection': ['请等待服务端视频检测完成（READY）后发布', 'Wait for server-side video detection to complete (READY) before publishing'],
  ...
  'meta.instagramCaptionLimit': ['Instagram 文案最多 2200 字符', 'Instagram caption must be no more than 2200 characters'],
  'meta.facebookMessageLimit': ['Facebook 正文最多 5000 字符', 'Facebook message must be no more than 5000 characters'],
  'meta.accountRequired': ['请选择至少一个发布账号', 'Select at least one publishing account'],
  'meta.accountLimit': ['每次最多选择 20 个发布账号', 'Select no more than 20 publishing accounts at a time'],
  'meta.accountUnavailable': ['所选账号不可用或平台暂不支持，请刷新账号并重新授权', 'The selected account is unavailable or its platform is unsupported. Refresh accounts and reauthorize'],
  'meta.instagramMediaRequired': ['Instagram 需要视频或图片媒体', 'Instagram requires video or image media'],
  'meta.facebookTextRequired': ['Facebook 纯文本发布需要填写正文', 'Facebook text-only publishing requires a message'],
  'meta.retryUnavailable': ['此状态不可重试；结果未知时须先人工核验平台，避免重复发布', 'This status cannot be retried. Verify an unknown result on the platform first to avoid duplicate publishing'],
  'meta.statusSyncRequested': ['已请求核对平台状态，请等待异步更新。', 'A platform status check was requested. Wait for the asynchronous update.'],
  'meta.insightsFieldsRequired': ['请填写指标和周期', 'Enter a metric and period'],
  'meta.operationFailed': ['操作失败，请重试', 'Operation failed. Try again'],
  'meta.authIncomplete': ['授权未完成，请检查账号权限或绑定归属后重试', 'Authorization is incomplete. Check the account permissions and Page ownership, then try again'],
  'meta.instagramProfileReadFailed': ['无法读取 Instagram 专业账号信息，请检查账号类型后重试', 'Unable to read the Instagram professional account. Check the account type and try again'],
  'meta.ossUploadNetworkFailed': ['OSS 上传失败，请检查网络后重试', 'OSS upload failed. Check the network and try again'],
  'meta.invalidMp4': ['文件不是有效的 MP4 视频', 'The file is not a valid MP4 video'],
  'meta.mediaUploadBusy': ['已有媒体正在上传，请稍后重试', 'Another media upload is in progress. Try again later'],
  ...
  'meta.videoInspectionPending': ['视频检测中，请稍后重试', 'Video inspection is in progress. Try again later'],
  'meta.videoCheckFailed': ['视频尚未通过服务端检查', 'The video has not passed server-side checks'],
  'meta.instagramMediaRequiredServer': ['Instagram 发布需要图片或视频', 'Instagram publishing requires an image or video'],
...
export const translateMetaText = (text?: string, locale: string = 'zh-CN') => {
  ...
  const patterns: Array<[RegExp, (match: RegExpMatchArray) => string]> = [
    ...
    [/^文件大小须大于 0 且不超过 (\d+) MB$/, match => `File size must be greater than 0 and no more than ${match[1]} MB`],
    [/^OSS 上传失败（HTTP (\d+)）$/, match => `OSS upload failed (HTTP ${match[1]})`],
    [/^任务 #(\d+) 已加入队列，平台正在异步处理。$/, match => `Task #${match[1]} was queued and is being processed asynchronously.`]
  ]
