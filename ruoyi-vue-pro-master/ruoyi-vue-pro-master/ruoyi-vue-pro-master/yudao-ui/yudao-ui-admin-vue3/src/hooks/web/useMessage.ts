...
const createMessageOptions = (content: string) => ({
  message: content,
...
export const useMessage = () => {
  ...
  return {
    // 消息提示
    info(content: string) {
      ElMessage.info(createMessageOptions(content))
    },
    // 错误消息
    error(content: string) {
      ElMessage.error(createMessageOptions(content))
    },
    // 成功消息
    success(content: string) {
      ElMessage.success(createMessageOptions(content))
    },
    // 警告消息
    warning(content: string) {
      ElMessage.warning(createMessageOptions(content))
    },
    // 弹出提示
