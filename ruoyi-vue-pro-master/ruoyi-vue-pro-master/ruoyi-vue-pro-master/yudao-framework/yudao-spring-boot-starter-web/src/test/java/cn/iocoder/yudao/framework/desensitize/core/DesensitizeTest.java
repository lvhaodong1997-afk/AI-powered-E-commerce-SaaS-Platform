...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname("秀美源码");
        ...
        desensitizeDemo.setRegex("你好，我是秀美源码");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("秀美源码");
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "秀美源码", replacer = "*")
